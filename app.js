...
// =========================================================================
// READERS roster — pre-baked profiles, generated by analysis/build_profile.py
// On performance day "Next reader" walks through this list in order.
// =========================================================================
const READERS = [
  {
    reader: "sid",
    song_title: "Shiny kindness",
    artist: "Helen Sun",
    knobs: {
      base_palette: {
        primary: { hue: 40, sat: 46, light: 57 },
        accent:  { hue: 351, sat: 71, light: 69 },
      },
      palette_drift_range: 45.9,
      brightness_curve: "linear",
      pulse_rate_hz: 1.872,
      motion_smear_decay: 0.931,
      panic_palette:    { hue: 352, sat: 80, light: 64 },
      missed_word_scar: { hue: 40,  sat: 36, light: 14 },
      bridge_palette:   null,
      bridge_trigger:   null,
    },
  },
  {
    ...
    knobs: {
      base_palette: {
        primary: { hue: 346, sat: 77, light: 49 },
        accent:  { hue: 342, sat: 95, light: 61 },
      },
      palette_drift_range: 49.7,
      brightness_curve: "linear",
      pulse_rate_hz: 1.795,
      motion_smear_decay: 0.878,
      panic_palette:    { hue: 345, sat: 99, light: 56 },
      missed_word_scar: { hue: 346, sat: 67, light: 14 },
      bridge_palette:   { hue: 286, sat: 57, light: 59 },
...
function currentProfile() {
  return READERS[state.readerIdx];
}
